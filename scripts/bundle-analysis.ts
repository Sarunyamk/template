...
interface BuildManifest {
  ampDevFiles: Array<string>;
  ampFirstPages: Array<string>;
  devFiles: Array<string>;
  lowPriorityFiles: Array<string>;
  pages: Record<string, Array<string>>;
  polyfillFiles: Array<string>;
  rootMainFiles: Array<string>;
}
...
(async () => {
  try {
     ...
     */
    const getScriptSizes = async (scriptPaths: Array<string>) => {
